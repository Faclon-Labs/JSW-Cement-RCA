...
import { GET_MONGO_DATA, CREATE_MONGO_ROWS_URL, Protocol, VERSION } from '../utils/constants.js';
export default class MachineTimeline {
    ...
    convertToIST(dateInput, userTimezone = this.tz) {
        /**
    ...
    processDataForInsertion(data) {
        ...
        processedData.rows = data.rows.map((row) => {
            if (!row.data)
                return row;
...
//# sourceMappingURL=MachineTimeline.js.map