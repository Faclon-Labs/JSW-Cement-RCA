...
import { FETCH_USER_INSIGHTS_URL, GET_SOURCE_INSIGHT_URL, FETCH_INSIGHT_RESULTS_URL, Protocol, VERSION, MAX_RETRIES, RETRY_DELAY } from '../utils/constants.js';
import DataAccess from './DataAccess.js';
export default class BruceHandler {
    constructor({ userId, dataUrl, onPrem = false, tz = 'UTC' }) {
    ...
    async fetchUserInsights(options = {}) {
        /**
         ...
         */
        const { pagination = { page: 1, count: 1000 }, populate = [
            {
                path: "sourceInsightID",
                select: "insightID insightProperty tags source"
            }
        ], sort = { "createdAt": -1 }, projection = null, onPrem } = options;
    ...
    async getSourceInsight(options) {
        /**
    ...
    convertToUtc(time, timezone = 'UTC') {
        /**
    ...
    async fetchInsightResults(options) {
        /**
...
//# sourceMappingURL=bruceHandler.js.map